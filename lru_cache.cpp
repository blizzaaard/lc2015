...
class LRUCache{
    ...
    typedef std::unordered_map<int, List::iterator> Hash;
  ...
  public:
    ...
    int get(int key)
    {
        ...
        if (m_hash.end() != it) {
            ...
            // Place the accessed key-value pair to the front of the list.
    ...
    void set(int key, int value)
    {
        ...
        m_list.push_front(std::make_pair(key, value));
        m_hash.insert(std::make_pair(key, m_list.begin()));
    }
};
